    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
      ...
      <div class="col">
        <div class="card h-100">
          <img src="images/paxel.png" class="card-img-top w-100" style="height: 200px; object-fit: cover;" alt="Paxel">
          <div class="card-body d-flex flex-column">
            <h5 class="card-title">Paxel</h5>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="card h-100">
          <img src="images/kiriminaja.png" class="card-img-top w-100" style="height: 200px; object-fit: cover;" alt="Kiriminaja">
          <div class="card-body d-flex flex-column">
            <h5 class="card-title">Kiriminaja</h5>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="card h-100">
          <img src="images/spxinstan.png" class="card-img-top w-100" style="height: 200px; object-fit: cover;" alt="SPX Instan">
          <div class="card-body d-flex flex-column">
            <h5 class="card-title">SPX Instan</h5>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="card h-100">
          <img src="images/grabinstan.jpeg" class="card-img-top w-100" style="height: 200px; object-fit: cover;" alt="Grab Instan">
          <div class="card-body d-flex flex-column">
            <h5 class="card-title">Grab Instan</h5>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="card h-100">
          <img src="images/gosend.jpeg" class="card-img-top w-100" style="height: 200px; object-fit: cover;" alt="Gosend Instan">
          <div class="card-body d-flex flex-column">
            <h5 class="card-title">Gosend Instan</h5>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="card h-100">
          <img src="images/lalamove.png" class="card-img-top w-100" style="height: 200px; object-fit: cover;" alt="Lalamove">
          <div class="card-body d-flex flex-column">
            <h5 class="card-title">Lalamove</h5>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 mb-4">
          ...
          <span class="fw-bold" style="font-size: 15px;">LaKue</span>
          ...
          <a href="#" aria-label="Instagram"><i class="bi bi-instagram me-2"></i></a>
          <a href="#" aria-label="YouTube"><i class="bi bi-youtube me-2"></i></a>
