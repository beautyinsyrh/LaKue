...
<body>
  ...
  <div class="my-4">
    <h3 class="text-center">Our Best Seller</h3>
  </div>

  <!-- CARDS -->
  <div class="container my-4 card-group mb-4">
    <div class="card">
      <img src="images/Scake.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">1st Best Seller - Strawberry Shortcake</h5>
        <p class="card-text">Cake spesial dengan rasa strawberry premium dan cream vanilla yang laris manis.</p>
        <a href="<?= $isLoggedIn ? 'pesan.php' : '#' ?>" class="btn btn-lg btn-primary pesan-btn">Pesan</a>
      </div>
    </div>
    <div class="card">
      <img src="images/Ccake.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">2nd Best Seller - Chocolate Cake</h5>
        <p class="card-text">Cake cokelat lembut dengan paduan dark chocolate dan chocolate milk sehingga menghasilkan rasa yang nikmat</p>
        <a href="<?= $isLoggedIn ? 'pesan.php' : '#' ?>" class="btn btn-lg btn-primary pesan-btn">Pesan</a>
      </div>
    </div>
    <div class="card">
      <img src="images/CBcake.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">3rd Best Seller - Creme Brulee Cake</h5>
        <p class="card-text">Cake vanilla dipadukan dengan lelehan gula sebagai topping</p>
        <a href="<?= $isLoggedIn ? 'pesan.php' : '#' ?>" class="btn btn-lg btn-primary pesan-btn">Pesan</a>
      </div>
    </div>
  </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            Untuk memesan, kamu harus login terlebih dahulu.
          </div>
